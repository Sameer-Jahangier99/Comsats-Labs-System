                                            ...
                                            allComplaints.map((item) => (
                                                <tr key={item._id}>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        {item.worksApproved == null ? <> <CButton color="success" className='text-white' onClick={() => approveComplaint(item)}>{item.worksApproved ? 'Approved' : "Approve"}</CButton> <CButton color="danger" className='text-white' onClick={() => rejectComplaint(item)}>{item.worksApproved == null ? 'Reject ' : "Rejected"}</CButton> </> : item.worksApproved ? <CButton color="success" className='text-white' onClick={() => approveComplaint(item)}>{item.worksApproved ? 'Approved' : "Approve"}</CButton> : <CButton color="danger" className='text-white' onClick={() => rejectComplaint(item)}>{!item.worksApproved ? 'Rejected' : "Reject"}</CButton>}
                                                    </td>
                                                </tr>
